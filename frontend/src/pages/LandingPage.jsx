...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-slate-100 font-sans selection:bg-teal-500 selection:text-white">
      {/* ---------------- NAVIGATION HEADER ---------------- */}
      <header className="sticky top-0 z-40 w-full backdrop-blur-md bg-white/90 dark:bg-slate-900/90 border-b border-slate-200/80 dark:border-slate-800 transition-all shadow-sm">
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 h-16 sm:h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: "smooth" })}>
            <div className="flex aspect-square h-9 w-9 sm:h-11 sm:w-11 shrink-0 items-center justify-center rounded-xl bg-slate-950 p-1 border border-slate-900 shadow-md overflow-hidden">
              <img src="/teeth_talk_logo.png" alt="Teeth Talk Dental Clinic Logo" className="h-full w-full object-contain" />
            </div>
            <div>
              <div className="flex items-center gap-1.5">
                <span className="font-extrabold text-sm sm:text-base tracking-tight text-slate-900 dark:text-white whitespace-nowrap">Teeth Talk</span>
                <span className="text-[8px] sm:text-[9px] font-extrabold bg-slate-950 border border-slate-800 text-teal-400 px-1.5 py-0.5 rounded uppercase">CLINIC</span>
              </div>
              <span className="text-[9px] sm:text-[10px] font-semibold text-slate-400 uppercase tracking-wider block -mt-0.5 truncate">
          ...
          <div className="hidden sm:flex items-center gap-2.5">
            ...
            <Button
              ...
              className="bg-slate-950 hover:bg-slate-900 text-white shadow-md font-semibold text-xs rounded-xl px-3.5 py-2"
            >
          ...
          <div className="flex sm:hidden items-center gap-1.5">
            <Button
              ...
              size="sm"
              onClick={openLoginModal}
              className="text-slate-700 dark:text-slate-200 font-bold text-xs px-2 py-1 h-8"
            >
              Login
            </Button>
            <Button
              size="sm"
              onClick={() => setIsBookingModalOpen(true)}
              className="bg-slate-950 hover:bg-slate-900 text-white font-semibold text-xs rounded-lg px-2.5 py-1 h-8 flex items-center gap-1 shadow-sm"
            >
            ...
            <button
              ...
              className="p-1.5 rounded-lg text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors ml-0.5"
              aria-label="Toggle navigation menu"
            >
              {isMobileMenuOpen ? <X className="w-5 h-5 text-teal-600" /> : <Menu className="w-5 h-5" />}
            </button>
          </div>
        </div>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden border-t border-slate-200 dark:border-slate-800 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md px-4 py-4 space-y-3 shadow-xl transition-all animate-in slide-in-from-top-2">
            <nav className="flex flex-col space-y-2 text-sm font-medium text-slate-700 dark:text-slate-200">
              ...
              >
                About Us (Dr. Meg Cyrene Arellano)
              </a>
              <a
                href="#branches"
                onClick={() => setIsMobileMenuOpen(false)}
                className="px-3 py-2 rounded-lg hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
              >
                Our 3 Branches (Pasig, Fairview, San Juan)
              </a>
              <a
                href="#services"
                onClick={() => setIsMobileMenuOpen(false)}
            ...
            <div className="pt-3 border-t border-slate-200 dark:border-slate-800 flex flex-col gap-2">
              <Button
                ...
                className="w-full bg-gradient-to-r from-teal-600 to-cyan-600 text-white font-bold text-xs py-2.5 rounded-xl shadow-md flex items-center justify-center gap-1.5"
              >
              ...
              <Button
                ...
                className="w-full font-bold text-xs py-2.5 rounded-xl border-slate-300 dark:border-slate-700"
              >
                <UserCheck className="w-4 h-4 mr-1.5 text-teal-600" />
                Patient Portal Login / Sign In
              </Button>
            </div>
          </div>
        )}
      ...
      <main>
        {/* ---------------- HERO SECTION ---------------- */}
        <section id="hero" className="relative overflow-hidden pt-8 pb-16 sm:pt-14 sm:pb-20 lg:pt-20 lg:pb-28 bg-gradient-to-b from-teal-50/60 via-slate-50 to-white dark:from-slate-900/60 dark:via-slate-950 dark:to-slate-950">
          ...
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-4 sm:space-y-6 text-left">
              <div className="inline-block max-w-full">
                <Badge variant="outline" className="px-2.5 py-1.5 sm:px-4 sm:py-1.5 rounded-full border-teal-200 dark:border-teal-800 bg-white/90 dark:bg-slate-900/90 text-teal-800 dark:text-teal-300 font-semibold text-[10px] sm:text-sm shadow-sm inline-flex items-center gap-1.5 max-w-full text-left leading-tight sm:leading-snug">
                  <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-teal-600 dark:text-teal-400 shrink-0" />
                  <span className="break-words">Quality & Affordable Care • Founded by Dr. Meg Cyrene Arellano</span>
                </Badge>
              </div>

              <h1 className="text-2xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 dark:text-white leading-[1.18] sm:leading-[1.15]">
              ...
              <p className="text-xs sm:text-lg text-slate-600 dark:text-slate-300 leading-relaxed max-w-2xl">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-3 pt-1 sm:pt-2 w-full sm:w-auto">
                <Button
                  size="lg"
                  onClick={() => setIsBookingModalOpen(true)}
                  className="w-full sm:w-auto bg-gradient-to-r from-teal-600 to-cyan-600 hover:from-teal-700 hover:to-cyan-700 text-white font-bold text-xs sm:text-base px-4 sm:px-6 py-3.5 sm:py-6 rounded-xl shadow-lg shadow-teal-600/25 transition-all hover:scale-[1.02] flex items-center justify-center"
                >
                  <CalendarIcon className="w-4 h-4 sm:w-5 sm:h-5 mr-1.5 sm:mr-2 text-teal-200" />
                ...
                <a href="#system" className="w-full sm:w-auto">
                  <Button
                    size="lg"
                    variant="outline"
                    className="w-full sm:w-auto border-slate-300 dark:border-slate-700 font-semibold text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 text-xs sm:text-base px-4 sm:px-6 py-3.5 sm:py-6 rounded-xl flex items-center justify-center"
                  >
                    <Laptop className="w-4 h-4 sm:w-5 sm:h-5 mr-1.5 sm:mr-2 text-teal-600 dark:text-teal-400" />
              ...
              {/* Trust Badges Bar */}
              <div className="pt-4 sm:pt-6 border-t border-slate-200 dark:border-slate-800 grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-4 text-left">
                <div className="flex items-center gap-2 sm:gap-3 p-2 rounded-xl bg-white/70 dark:bg-slate-900/70 sm:bg-transparent sm:p-0 border border-slate-100 sm:border-0 dark:border-slate-800 min-w-0">
                  <div className="p-1.5 sm:p-2.5 rounded-xl bg-teal-100 dark:bg-teal-950/60 text-teal-700 dark:text-teal-400 shrink-0">
                    <UserCheck className="w-3.5 h-3.5 sm:w-5 sm:h-5" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <p className="text-sm sm:text-xl font-bold text-slate-900 dark:text-white truncate">15,000+</p>
                    <p className="text-[9px] sm:text-xs text-slate-500 dark:text-slate-400 font-medium truncate">Happy Patients</p>
                  </div>
                </div>

                <div className="flex items-center gap-2 sm:gap-3 p-2 rounded-xl bg-white/70 dark:bg-slate-900/70 sm:bg-transparent sm:p-0 border border-slate-100 sm:border-0 dark:border-slate-800 min-w-0">
                  <div className="p-1.5 sm:p-2.5 rounded-xl bg-cyan-100 dark:bg-cyan-950/60 text-cyan-700 dark:text-cyan-400 shrink-0">
                    <MapPin className="w-3.5 h-3.5 sm:w-5 sm:h-5" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <p className="text-sm sm:text-xl font-bold text-slate-900 dark:text-white truncate">3 Branches</p>
                    <p className="text-[9px] sm:text-xs text-slate-500 dark:text-slate-400 font-medium truncate">Pasig, Fairview, San Juan</p>
                  </div>
                </div>

                <div className="flex items-center gap-2 sm:gap-3 p-2 rounded-xl bg-white/70 dark:bg-slate-900/70 sm:bg-transparent sm:p-0 border border-slate-100 sm:border-0 dark:border-slate-800 min-w-0">
                  <div className="p-1.5 sm:p-2.5 rounded-xl bg-amber-100 dark:bg-amber-950/60 text-amber-700 dark:text-amber-400 shrink-0">
                    <Star className="w-3.5 h-3.5 sm:w-5 sm:h-5 fill-amber-400" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <p className="text-sm sm:text-xl font-bold text-slate-900 dark:text-white truncate">4.9 / 5.0</p>
                    <p className="text-[9px] sm:text-xs text-slate-500 dark:text-slate-400 font-medium truncate">Satisfaction</p>
                  </div>
                </div>

                <div className="flex items-center gap-2 sm:gap-3 p-2 rounded-xl bg-white/70 dark:bg-slate-900/70 sm:bg-transparent sm:p-0 border border-slate-100 sm:border-0 dark:border-slate-800 min-w-0">
                  <div className="p-1.5 sm:p-2.5 rounded-xl bg-purple-100 dark:bg-purple-950/60 text-purple-700 dark:text-purple-400 shrink-0">
                    <Zap className="w-3.5 h-3.5 sm:w-5 sm:h-5" />
                  </div>
                  <div className="min-w-0 flex-1">
                    <p className="text-sm sm:text-xl font-bold text-slate-900 dark:text-white truncate">24/7 AI</p>
                    <p className="text-[9px] sm:text-xs text-slate-500 dark:text-slate-400 font-medium truncate">Smart Support</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-5 relative mt-4 lg:mt-0">
              <div className="relative mx-auto max-w-sm sm:max-w-md lg:max-w-none">
                ...
                <div className="relative rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-2.5 sm:p-4 shadow-2xl overflow-hidden">
                  <div className="relative h-56 sm:h-80 rounded-2xl overflow-hidden bg-slate-100 dark:bg-slate-800">
                    <img
                    ...
                    <div className="absolute bottom-2 left-2 right-2 sm:bottom-4 sm:left-4 sm:right-4 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md rounded-xl p-2 sm:p-3 border border-slate-200/50 dark:border-slate-700/50 flex items-center justify-between shadow-lg">
                      <div className="flex items-center gap-2 sm:gap-3 min-w-0">
                        <div className="w-7 h-7 sm:w-10 sm:h-10 rounded-full overflow-hidden border-2 border-teal-500 bg-teal-100 shrink-0">
                          <img src="/dr_meg_arellano.png" alt="Dr. Meg Cyrene Arellano" className="w-full h-full object-cover" />
                        </div>
                        <div className="min-w-0">
                          <p className="text-[11px] sm:text-sm font-bold text-slate-900 dark:text-white truncate">Dr. Meg Cyrene Arellano</p>
                          <p className="text-[9px] sm:text-xs text-teal-600 dark:text-teal-400 font-medium truncate">Founder & Head Dentist</p>
                        </div>
                      </div>
                      <Badge className="bg-emerald-500 text-white text-[8px] sm:text-[10px] font-bold px-1.5 sm:px-2 py-0.5 whitespace-nowrap shrink-0">
                        Accepting Patients
                      </Badge>
                    </div>
                  </div>
                  ...
                  <div className="mt-2.5 sm:mt-4 grid grid-cols-2 gap-2 sm:gap-3">
                    <div className="p-2 sm:p-3 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-800 flex items-center gap-2 sm:gap-3 min-w-0">
                      <Clock className="w-3.5 h-3.5 sm:w-5 sm:h-5 text-teal-600 dark:text-teal-400 shrink-0" />
                      <div className="min-w-0">
                        <p className="text-[11px] sm:text-xs font-bold text-slate-900 dark:text-white truncate">Real-Time Booking</p>
                        <p className="text-[9px] sm:text-[11px] text-slate-500 dark:text-slate-400 truncate">Zero wait queues</p>
                      </div>
                    </div>

                    <div className="p-2 sm:p-3 rounded-xl bg-slate-50 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-800 flex items-center gap-2 sm:gap-3 min-w-0">
                      <CreditCard className="w-3.5 h-3.5 sm:w-5 sm:h-5 text-cyan-600 dark:text-cyan-400 shrink-0" />
                      <div className="min-w-0">
                        <p className="text-[11px] sm:text-xs font-bold text-slate-900 dark:text-white truncate">Flexible Payments</p>
                        <p className="text-[9px] sm:text-[11px] text-slate-500 dark:text-slate-400 truncate">Cash, GCash, Maya, Cards</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50">
        {!isAiWidgetOpen ? (
          <button
            ...
            className="group flex items-center gap-2.5 sm:gap-3 bg-gradient-to-r from-teal-600 to-cyan-600 text-white px-4 py-3 sm:px-5 sm:py-3.5 rounded-full shadow-2xl hover:scale-105 transition-all duration-300 border-2 border-white/20"
          >
          ...
          <div className="w-[calc(100vw-2rem)] max-w-sm sm:w-96 bg-slate-900 text-white rounded-3xl shadow-2xl border border-slate-700 overflow-hidden flex flex-col h-[440px] sm:h-[480px]">
            {/* Widget Header */}
            <div className="p-3.5 sm:p-4 bg-gradient-to-r from-teal-700 to-cyan-700 flex items-center justify-between">
            ...
            {/* Widget Messages */}
            <div className="p-3.5 sm:p-4 flex-1 overflow-y-auto space-y-3 text-xs bg-slate-950">
